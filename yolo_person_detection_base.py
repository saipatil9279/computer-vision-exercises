...
output_video_path = os.path.join(output_dir, 'yolo_person_detection_base.mp4')
...
while True:
    ...
    # Running theyolo inference on the current frame
    results = model.predict(source=frame, imgsz=640, conf=0.25, classes=[0], verbose=False)
