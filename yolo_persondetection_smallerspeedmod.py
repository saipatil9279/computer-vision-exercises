...
output_video_path = os.path.join(output_dir, 'yolo_person_detection_smallerspeed.mp4')
...
while True:
    ...
    # Running theyolo inference with a smaller size (320)
    results = model.predict(source=frame, imgsz=320, conf=0.25, classes=[0], verbose=False)
